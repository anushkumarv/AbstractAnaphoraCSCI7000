...
if __name__ == '__main__':
    ...
    df = pd.DataFrame(data, columns = ['sent_distance', 'token_distance','relative_pos','direct_dominance','dominance','candidate_path','negated_candidate','candidate_transitivity'])
    print(df)
