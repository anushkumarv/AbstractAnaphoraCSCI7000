...
from feature_extractor_antecedent_conll import extract_classifier_features
...
def train_and_report(args):
    ...
    if argparse.conll:
        ...
        df_conll = extract_classifier_features()
...
if '__name__' == '__main__':
    ...
    parser.add_argument('--conll', type=bool, required=True)
